...
export const shipmentAO = () => {
  ...
  // const handleDateChange = (index, name, date) => {
  //   console.log(`Changing date for row ${index}, field ${name}, to ${date}`); // Debugging log
  //   if (date && dayjs(date).isValid()) {
  //     const newTableData = [...tableData1];
  //     newTableData[index][name] = date;
  //     setTableData1(newTableData);
  //     console.log('Updated tableData1:', newTableData); // Debugging log
  //     setFieldErrors({ ...fieldErrors, [name]: '' });
  //   } else {
  //     setFieldErrors({ ...fieldErrors, [name]: `${name} is required` });
  //   }
  ...
  const handleSave = () => {
    ...
    const payload = {
      ...
      packingListDTO: tableData.map((row) => ({
      ...
      costEstimateDTO: tableData1.map((row) => ({
    ...
    axios
      .put(`${process.env.REACT_APP_API_URL}/api/Transaction/updateCreateShipmentAO`, payload)
      .then((response) => {
        ...
        toast.success('Shipment AO Created Successfully', {
          autoClose: 2000,
          theme: 'colored'
        });
      })
      .catch((error) => {
        ...
        toast.error('An error occurred while saving the shipment AO');
      });
  };
          ...
          <div className="row d-flex ml">
            ...
            <div className="col-md-4 mb-3">
              <TextField
                ...
                size="small"
                disabled
                // value={formData.globalShipNo}
                // onChange={handleInputChange}
                // error={fieldErrors.globalShipNo}
                // helperText={fieldErrors.globalShipNo}
              />
            </div>
            <div className="col-md-4 mb-3">
              <TextField
              ...
              <FormControl fullWidth variant="filled" size="small">
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    ...
                    disabled
                    // onChange={(date) => handleDateChange('jobDate', date)}
                    // renderInput={(params) => (
                    //   <TextField {...params} size="small" error={!!fieldErrors.jobDate} helperText={fieldErrors.jobDate} />
                    // )}
                  />
                </LocalizationProvider>
              </FormControl>
            ...
            <div className="col-md-4 mb-3">
              <TextField
                ...
                // onChange={handleInputChange}
                // error={fieldErrors.hawbNO}
                // helperText={fieldErrors.hawbNO}
              />
            </div>
            <div className="col-md-4 mb-3">
              <FormControl fullWidth variant="filled" size="small">
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    label="HAWB Date"
                    // value={formData.hawbDate}
                    slotProps={{
                      textField: { size: 'small', clearable: true }
                    }}
                    disabled
                    // onChange={(date) => handleDateChange('hawbDate', date)}
                    // renderInput={(params) => (
                    //   <TextField {...params} size="small" error={!!fieldErrors.hawbDate} helperText={fieldErrors.hawbDate} />
                    // )}
                  />
                </LocalizationProvider>
              </FormControl>
            ...
            <div className="col-md-4 mb-3">
              <TextField
                ...
                // onChange={handleInputChange}
                // error={fieldErrors.mawbNo}
                // helperText={fieldErrors.mawbNo}
              />
            </div>
            <div className="col-md-4 mb-3">
              <FormControl fullWidth variant="filled" size="small">
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    label="MAWB Date"
                    // value={formData.mawbDate}
                    slotProps={{
                      textField: { size: 'small', clearable: true }
                    }}
                    disabled
                    // onChange={(date) => handleDateChange('mawbDate', date)}
                    // renderInput={(params) => (
                    //   <TextField {...params} size="small" error={!!fieldErrors.mawbDate} helperText={fieldErrors.mawbDate} />
                    // )}
                  />
                </LocalizationProvider>
              </FormControl>
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      name="masterFinalize"
                      disabled
                      // checked={formData.masterFinalize}
                      // onChange={(e) => handleInputChange({ target: { name: 'masterFinalize', value: e.target.checked } })}
                    />
                  }
