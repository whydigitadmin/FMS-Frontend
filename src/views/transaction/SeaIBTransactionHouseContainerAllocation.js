...
export const SeaIBTransactionHouseContainerAllocation = () => {
                  ...
                  <table className="table table-bordered">
                    <thead>
                      <tr style={{ backgroundColor: '#434AA8' }}>
                        ...
                        <th className="px-2 py-2 text-white">Tot Pkgs</th>
                        <th className="px-2 py-2 text-white">Gr. Weight</th>
                      </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr key={row.id}>
                          ...
                          <td className="border px-2 py-2">
                            <select
                              value={row.houseNo}
                              onChange={(e) =>
                                setTableData((prev) => prev.map((r) => (r.id === row.id ? { ...r, houseNo: e.target.value } : r)))
                              }
                          ...
                          <td className="border px-2 py-2">
                            ...
                            />
                            {tableErrors[index]?.jobNo && <div style={{ color: 'red', fontSize: '12px' }}>{tableErrors[index].jobNo}</div>}
                          </td>
                          ...
                          <td className="border px-2 py-2">
                            <select
                              ...
                              onChange={(e) =>
                                setTableData((prev) => prev.map((r) => (r.id === row.id ? { ...r, containerNo: e.target.value } : r)))
                              }
                              // onKeyDown={(e) => handleKeyDown(e, row)}
                            >
                              <option value="Yes">Yes</option>
...
export default SeaIBTransactionHouseContainerAllocation;
