        ...
        <>
          ...
          <div className="row d-flex ml">
            ...
            <div className="col-md-4 mb-3">
              ...
              >
                <InputLabel id="shipper">Agent / Partner</InputLabel>
                <Select
                  labelId="agentPartner"
                  label="Agent / Partner"
                  name="agentPartner"
            ...
            <div className="col-md-4 mb-3">
              <FormControl
                ...
                // error={!!fieldErrors.gender}
              >
                <InputLabel id="consignee">Carrier</InputLabel>
                <Select
                  labelId="carrier"
                  label="Carrier"
                  name="carrier"
          ...
          <div className="row d-flex">
            ...
            <div className="col-md-4 mb-3">
              <FormControl
                ...
                // error={!!fieldErrors.gender}
              >
                <InputLabel id="consignee">Notify</InputLabel>
                <Select
                  labelId="notify"
                  label="Notify"
                  name="notify"
          ...
          <div className="row d-flex">
            ...
            <div className="col-md-4 mb-3">
              <FormControl
                ...
                // error={!!fieldErrors.gender}
              >
                <InputLabel id="bro">BRO</InputLabel>
                <Select
                  labelId="bro"
                  label="BRO"
                  name="bro"
          ...
          <div className="row d-flex">
            ...
            <div className="col-md-4 mb-3">
              <FormControl
                ...
                // error={!!fieldErrors.gender}
              >
                <InputLabel id="lossType">Loss Type</InputLabel>
                <Select
                  labelId="lossType"
                  label="Loss Type"
                  name="lossType"
