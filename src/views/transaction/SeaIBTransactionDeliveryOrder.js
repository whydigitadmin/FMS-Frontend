...
export const SeaIBTransactionDeliveryOrder = () => {
        ...
        <>
          ...
          <div className="row d-flex ml">
            ...
            <div className="col-md-4 mb-3">
              ...
              >
                <InputLabel id="nominatedBy">Order To</InputLabel>
                <Select
                  labelId="orderTo"
                  label="Order To"
                  name="orderTo"
          ...
          <div className="row d-flex">
            ...
            <div className="col-md-4 mb-3">
              <FormControl
                ...
                // error={!!fieldErrors.gender}
              >
                <InputLabel id="nominatedBy">BRO Rcvd</InputLabel>
                <Select
                  labelId="broRcvd"
                  label="BRO Rcvd"
                  name="broRcvd"
...
export default SeaIBTransactionDeliveryOrder;
