...
export const AirIBTransactionAdvanceCan = () => {
                          ...
                          <tr key={row.id}>
                            ...
                            <td className="border px-2 py-2">
                              <select
                                value={row.taxable}
                                onChange={(e) =>
                                  setTableData((prev) => prev.map((r) => (r.id === row.id ? { ...r, taxable: e.target.value } : r)))
                                }
                                // onKeyDown={(e) => handleKeyDown(e, row)}
                              >
                                <option value="Yes">Yes</option>
                            ...
                            <td className="border px-2 py-2">
                              <select
                                value={row.ccf}
                                onChange={(e) =>
                                  setTableData((prev) => prev.map((r) => (r.id === row.id ? { ...r, ccf: e.target.value } : r)))
                                }
                                // onKeyDown={(e) => handleKeyDown(e, row)}
                              >
                                <option value="Yes">Yes</option>
...
export default AirIBTransactionAdvanceCan;
