...
export const HouseBillOfLading = () => {
                  ...
                  <div className="row d-flex mt-3">
                    <div className="col-md-4 mb-3">
                      <FormControl
                        ...
                        // error={!!fieldErrors.gender}
                      >
                        <InputLabel id="printShipper">Print Shipper</InputLabel>
                        <Select
                          labelId="printShipper"
                          label="Print Shipper"
                          name="printShipper"
                          //   value={formData.gender} onChange={handleInputChange}
                        >
                    ...
                    <div className="col-md-4 mb-3">
                      <FormControl
                        ...
                        // error={!!fieldErrors.gender}
                      >
                        <InputLabel id="printConsignee">Print Consignee</InputLabel>
                        <Select
                          labelId="printConsignee"
                    ...
                    <div className="col-md-4 mb-3">
                      <FormControl
                        ...
                        // error={!!fieldErrors.gender}
                      >
                        <InputLabel id="printNotify">Print Notify</InputLabel>
                        <Select
                          labelId="printNotify"
                          label="Print Notify"
                          name="printNotify"
                    ...
                    <div className="col-md-4 mb-3">
                      <FormControl
                        ...
                        // error={!!fieldErrors.gender}
                      >
                        <InputLabel id="portOfReceipt">Port of Receipt</InputLabel>
                        <Select
                          labelId="portOfReceipt"
                ...
                {tabValue === 1 && (
                  <>
                    <div className="row d-flex mt-3">
                      ...
                      <div className="col-md-4 mb-3">
                        <TextField
                          id="quantityAndKindPackage"
                          fullWidth
                          name="quantityAndKindPackage"
                          label="Quantity and Kind Package"
                          size="small"
                          //   value={formData.employeeCode}
                          //   onChange={handleInputChange}
                          //   error={fieldErrors.employeeCode}
                    ...
                    <div className="row d-flex">
                      ...
                      <div className="col-md-4 mb-3">
                        <FormControl
                          ...
                          // error={!!fieldErrors.gender}
                        >
                          <InputLabel id="signatory">Signatory</InputLabel>
                          <Select
                            labelId="signatory"
                            label="Signatory"
                            name="signatory"
...
export default HouseBillOfLading;
